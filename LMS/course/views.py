...
class CoursesListView(View):
    def get(self, request):
        ...
        data ={'courses': course, 'page':'course-page'}
...
class InstructorCoursesView(View):
    ...
    def get(self, request,*args, **kwargs):
        ...
        data ={'page':'instructor-page','courses': Courses}
...
class InstructorCoursesDetailView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'courses/instructor-courses-details.html',context={'course': course})
...
class InstructorCoursesUpdateView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return render(request, 'courses/instructor-courses-update.html',context={'form': form})
